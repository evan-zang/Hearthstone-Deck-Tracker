...
namespace Hearthstone_Deck_Tracker.Windows
{
	public partial class OverlayWindow
	{
		...
		public void Update(bool refresh)
		{
			...
			var gameStarted = !_game.IsInMenu && _game.CurrentGame?.Entities.Count >= 67;
		...
		private void UpdateIcons()
		{
			...
			if (_game.CurrentGame?.Entities.Count > 67 && (IconBoardAttackPlayer.Visibility == Visible || IconBoardAttackOpponent.Visibility == Visible))
			{
